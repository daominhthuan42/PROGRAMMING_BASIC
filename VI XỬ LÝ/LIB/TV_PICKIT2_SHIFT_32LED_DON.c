...
VOID SANG_TAT_DAN_NGOAI_VAO_10LED(UNSIGNED INT8 DL,CHONDELAY)
{  
   IF (DEM_LED<10)
   {  
      XUAT_32LED_DON_1DW(Y);        
      Y=((Y+0X00000400)<<1)&0X001FF800;
      DELAY_CHON(DL,CHONDELAY);
   }
   ELSE  IF (DEM_LED<20)
   {  
...
VOID SANG_TAT_32LED2(UNSIGNED INT8 DL,CHONDELAY)
{
   IF (TGDLAY==1)             XUAT_32LED_DON_1DW(0X001FF100); 
      ELSE IF (TGDLAY==50)    XUAT_32LED_DON_1DW(0X00000000); 
      ELSE IF (TGDLAY==100)   XUAT_32LED_DON_1DW(0X001FF100);     
      ELSE IF (TGDLAY==150)   XUAT_32LED_DON_1DW(0X00000000);           
      ELSE IF (TGDLAY==200)  
      {
         TTCT_TD++;   Y=0;        TGDLAY=0;
      }
